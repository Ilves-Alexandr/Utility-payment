...
function EditWater({ transactionId, onUpdate }) {
    ...
    useEffect(() => {
        const fetchTransaction = async () => {
            try {
                ...
                const response = await axios.get(`${API_URL}/api/water/${transactionId}`, config);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`${API_URL}/api/water/${transactionId}`, updatedTransaction, config);
